...
class SaleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if( $data['rent_amount']){
            ...
            $data['paid_amount']= $data['rent_amount'];
        }
        ...
        $data['sale_type'] =1;
        if( $data['advance_amount']!=null && $data['return_date']==null){
            $data['sale_type'] =2;
        }
        if( $data['advance_amount']==null && $data['return_date']!=null){
            $data['sale_type'] =3;
        ...
        if( $data['order_delivery_date']){
            $data['order_delivery_date'] = $data['order_delivery_date'];
        }
    ...
    public function posSale()
    {
        ...
        if($role->hasPermissionTo('sales-add')){
            ...
            if(Auth::user()->role_id > 2 && config('staff_access') == 'own') {
                ...
                $recent_rent_order = Sale::where([['sale_status', 1],['sale_type', 3]])->orderBy('id', 'desc')->take(10)->get();
