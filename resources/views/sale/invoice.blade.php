...
<div style="max-width:400px;margin:0 auto">
	...
	@elseif($lims_sale_data->sale_type == 2)
		<table>
			 <tbody>
				 <tr>
                      <th align="left">{{trans('file.Total')}}:</th>
	...
	@elseif($lims_sale_data->sale_type == 3)
		<table>
			 <tbody>
				 <tr>
                      <th align="left">{{trans('file.Total')}}:</th>
				 ...
				 <tr>
					  ...
					  <th>OMR {{number_format((float)$lims_sale_data->deposit_amount, 3, '.', '')}}</th>
					  <th align="right"> :قيمة الايداع</th>
				  </tr>
				 <tr>
                      <th align="left">Delivery Date:</th>
					  <th>{{$lims_sale_data->delivery_date}}</th>
					  <th align="right"> :تاريخ التسليم او الوصول</th>
				  </tr>
				  <tr>
                      <th align="left">Return Date:</th>
					  <th>{{$lims_sale_data->return_date}}</th>
					  <th align="right"> :تاريخ العودة</th>
				  </tr>
			</tbody>
	</table>
	@endif
