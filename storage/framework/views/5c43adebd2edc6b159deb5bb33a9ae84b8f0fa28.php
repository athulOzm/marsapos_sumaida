                ...
                <div class="card">
                    ...
                    <div class="payment-options">
                        ...
                        <div class="column-5">
						 ...
						 <div class="column-5">
                            <button style="background-color: #00A11C;" type="button" class="btn btn-custom" data-toggle="modal" data-target="#recentRentOrders"><i class="dripicons-clock"></i> Rent Orders</button>
                        </div>
						<div class="column-5">
...
<div id="showCustomer" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
  <div role="document" class="modal-dialog">
                                ...
                                <div class="col-md-10">
                                    <div class="row">
									    ...
									    <div class="col-md-6">
                                            ...
                                            <input type="date" name="order_delivery_date" class="form-control numkey"  step="any">
                                        </div>
	...
	<!--Add Rent/Order-->
			<div id="add-order" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                <div role="document" class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 id="exampleModalLabel" class="modal-title"><?php echo e(trans('file.Finalize Sale')); ?></h5>
                                ...
                                <div class="col-md-10">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mt-1">
                                            ...
                                            <input type="text" name="rent_amount" class="form-control numkey"  step="any">
                                        </div>
                                    ...
                                    <div class="mt-3">
                                        <button id="submit-rent-btn" type="button" class="btn btn-primary"><?php echo e(trans('file.submit')); ?></button>
                                    </div>
                                </div>
                               <div class="col-md-2 qc" data-initial="1">
                                    <h4><strong><?php echo e(trans('file.Quick Cash')); ?></strong></h4>
...
<!-- Add Measurement-->
                    ...
                    <div class="modal-body">
                      <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
						 ...
						 <div class="row">
							...
							<!--<div class="col-md-6"><img src="<?php echo e(url('img','BodyMeasurement.jpg')); ?>" height="750" width="300"></div>-->
						</div>
                ...
                <div role="document" class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <ul class="nav nav-tabs" role="tablist">
                          <li class="nav-item">
                            <a class="nav-link active" href="#sale-latest" role="tab" data-toggle="tab">Rent Items List</a>
                          </li>
                        </ul>
                        <div class="tab-content">
                          <div role="tabpanel" class="tab-pane show active" id="sale-latest">
                              <div class="table-responsive">
                                <table class="table">
                                  ...
                                  <tbody>
                                    ...
                                    <?php $customer = DB::table('customers')->find($sale->customer_id); ?>
                                    <tr>
                                      <td style="width: auto"><?php echo e(date('d-m-Y', strtotime($sale->delivery_date))); ?></td>
									  <td ><?php echo e(date('d-m-Y', strtotime($sale->return_date))); ?></td>
                                      <td><?php echo e($sale->id); ?></td>
                                      <td><?php echo e($customer->name); ?></td>
									  <td><?php echo e($sale->deposit_amount); ?></td>
                                      <td><?php echo e($sale->rent_amount); ?></td>
                                      <td>
                                        <div class="btn-group">
											<a href="<?php echo e(route('sale.invoice', $sale->id)); ?>" class="btn btn-success btn-sm" title="Print"><i class="dripicons-document-new"></i></a>&nbsp;
                                            <?php if(in_array("sales-edit", $all_permission)): ?>
	...
	<!-- recent rent Order modal -->
            <div id="recentRentOrders" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                <div role="document" class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 id="exampleModalLabel" class="modal-title">Recent Rent Orders <div class="badge badge-primary"><?php echo e(trans('file.latest')); ?> 10</div></h5>
                      <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
                    </div>
                    <div class="modal-body">
                        <ul class="nav nav-tabs" role="tablist">
                          ...
                          <div role="tabpanel" class="tab-pane show active" id="sale-latest">
                              <div class="table-responsive">
                                <table class="table">
                                  ...
                                  <tbody>
                                    <?php $__currentLoopData = $recent_rent_order; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php $customer = DB::table('customers')->find($sale->customer_id); ?>
                                    <tr>
                                      <td style="width: auto"><?php echo e(date('d-m-Y', strtotime($sale->delivery_date))); ?></td>
									  <td ><?php echo e(date('d-m-Y', strtotime($sale->return_date))); ?></td>
...
<?php echo $__env->make('layout.top-head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sumayatha\resources\views/sale/pos.blade.php ENDPATH**/ ?>